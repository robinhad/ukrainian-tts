...
iface = gr.Interface(
    ...
    title="🤖💬🇺🇦 - ESPNET",
    description="Україномовний🇺🇦 TTS за допомогою ESPNET (щоб вручну поставити наголос, використовуйте + перед голосною). Озвучуйте до 4 разів швидше по посиланню: [https://brehunets.com](https://brehunets.com)",
    article=article,
    examples=[
        [
