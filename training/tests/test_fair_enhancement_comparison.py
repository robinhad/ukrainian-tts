...
def test_comparison_has_clearervoice_sidon_cascade() -> None:
...
def test_comparison_has_clearervoice_sidon_deepfilter_cascade() -> None:
    assert SUFFIXES["clearervoice_sidon_deepfilternet3"] == (
