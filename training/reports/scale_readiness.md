...
| Frontend tests | PASS | `19 passed in 5.10s` on 2026-07-22, including pinned-version mismatch rejection | `tests/`, `tests/frontend/expected_phonemes.json` | Preserve snapshot in later stages |
