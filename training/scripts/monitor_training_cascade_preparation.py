#!/usr/bin/env python3
"""Monitor cascade preprocessing and write power and Kyiv ETA records."""
...
def gpu_metrics() -> list[dict]:
    query = "index,uuid,utilization.gpu,memory.used,power.draw,power.limit,temperature.gpu"
    ...
    for line in output.splitlines():
        index, uuid, util, memory, power, limit, temperature = [
...
def main() -> int:
    ...
    while True:
        ...
        record = {
            ...
            "phase": "training_cascade_preprocessing",
            "processed": processed,
            "retained": ok,
            "failed": failed,
            "total": args.total,
            ...
            "rate_files_per_second": round(rate, 5),
