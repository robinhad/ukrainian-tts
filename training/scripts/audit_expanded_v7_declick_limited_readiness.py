#!/usr/bin/env python3
"""Audit the v7 de-clicked and peak-limited corpus before training."""
...
def main() -> int:
    ...
    gates = [
        ...
        gate(
            ...
            profile_ok,
            "Sidon, light de-essing, de-clicking, and peak limiting are on. The files are mono 24 kHz PCM24 WAV files.",
            manifest,
        ),
        gate(
            "Dataset validation",
