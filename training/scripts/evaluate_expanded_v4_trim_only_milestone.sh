...
MILESTONE_LABEL=${1:?Usage: evaluate_expanded_v4_trim_only_milestone.sh LABEL}
...
TEST_SET=expanded_v4_trim_only_eval
DECODE_DIR="${TTS_EXP}/decode_jets_milestone_${MILESTONE_LABEL}/${TEST_SET}"
MANIFEST="${ROOT}/data/expanded_v4_trim_only/manifests/${TEST_SET}.parquet"
REPORT=${REPORT:-"${ROOT}/reports/expanded_v4_trim_only_inference_${MILESTONE_LABEL}.json"}
COMMAND_LOG="${ROOT}/reports/expanded_v4_trim_only_${MILESTONE_LABEL}_evaluation_commands.jsonl"
