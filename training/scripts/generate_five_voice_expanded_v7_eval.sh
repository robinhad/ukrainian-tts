...
LABEL=${1:-100k}
TTS_EXP=${TTS_EXP:-"${ROOT}/exp_expanded_v7_sidon_deess_declick_limit_novoa/tts_jets_uk_24k_expanded_v7_sidon_deess_declick_limit_novoa_from_v6e94_100k"}
MODEL_FILE=${MODEL_FILE:-"milestones/${LABEL}.pth"}
OUTPUT=${OUTPUT_DIR:-"${ROOT}/eval/generated/five_voice_expanded_v7_sidon_deess_declick_limit_novoa_${LABEL}"}
REPORT=${REPORT:-"${ROOT}/reports/five_voice_expanded_v7_sidon_deess_declick_limit_novoa_${LABEL}.json"}
MANIFEST="${ROOT}/data/expanded_v7_sidon_deess_declick_limit_novoa/hybrid_manifest/all.parquet"
EVAL_SCP="${ROOT}/dump_expanded_v7_sidon_deess_declick_limit_novoa/xvector/expanded_v7_sidon_deess_declick_limit_novoa_eval/xvector.scp"
